...
module.exports.handleReply = async function ({
  ...
  let data = (await Currencies.getData(event.senderID)).ghepTime;
    ...
    return api.sendMessage({body:`『𝗟𝗶𝘀𝘁 𝗼𝗳 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀 | ${global.config.BOTNAME}』
...
=== [ 𝗔𝗗𝗠𝗜𝗡 𝗕𝗢𝗧 ] ===
  ...
  ❯ Zodiac: ♓
  ❯ Weight: 52kg
  ❯ Facebook: https://www.facebook.com/6ixAxie
  ❯ Thanks for using bot.`, attachment: (await global.nodemodule["axios"]({
url: (await global.nodemodule["axios"]('https://api.zeidbot.site/images/phongcanhimg')).data.data,
method: "GET",
responseType: "stream"
})).data
        ...
        case "3": {
          const axios = require('axios');
       api.unsendMessage(handleReply.messageID);
    return api.sendMessage({body: `🖥 𝗪𝗲𝗯 𝗮𝗽𝗶: https://jasper-2.jasperwuhndsm.repl.co/`, attachment: (await global.nodemodule["axios"]({
url: (await global.nodemodule["axios"]('https://api.zeidbot.site/images/phongcanhimg')).data.data,
method: "GET",
responseType: "stream"
})).data
