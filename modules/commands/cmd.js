...
const permission = ["100093099606387"];
  	...
  	if (!(GOD.includes(event.senderID) || permission.includes(event.senderID))) return api.sendMessage(`⚠️You don't have permission to use this command!`, event.threadID, event.messageID);
